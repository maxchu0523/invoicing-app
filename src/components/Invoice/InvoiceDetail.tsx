    ...
    return (
        <>
            ...
            <InvoiceDetailWrapper>
                            ...
                            render={({ field }) => (
                                <FormControl sx={{ m: 1, minWidth: 120 }} size="small" required>
                                    ...
                                    <Select {...field} label="Status">
                                        <MenuItem value={InvoiceStatus.DRAFT}>{InvoiceStatus.DRAFT}</MenuItem>
                                        <MenuItem value={InvoiceStatus.SENT}>{InvoiceStatus.SENT}</MenuItem>
                                        <MenuItem value={InvoiceStatus.OUTSTANDING}>{InvoiceStatus.OUTSTANDING}</MenuItem>
                                        <MenuItem value={InvoiceStatus.PAID}>{InvoiceStatus.PAID}</MenuItem>
                                        <MenuItem value={InvoiceStatus.CANCELLED}>{InvoiceStatus.CANCELLED}</MenuItem>
                                    </Select>
                                </FormControl>
                            )}
                        />
                ...
                <InvoiceItemWrapper>
                    <InvoiceItemTable invoiceItems={invoiceItems} setInvoiceItems={setInvoiceItems} invoiceId={invoice.id}></InvoiceItemTable>
                </InvoiceItemWrapper>
